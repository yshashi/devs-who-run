...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/VZELDaPUAO)
...
```sh
npx nx serve devs-who-run-vue
```

To create a production bundle:

```sh
npx nx build devs-who-run-vue
```

To see all available targets to run for a project, run:

```sh
npx nx show project devs-who-run-vue
```
